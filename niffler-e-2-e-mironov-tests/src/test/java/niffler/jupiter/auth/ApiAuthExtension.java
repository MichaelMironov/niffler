...
import static niffler.jupiter.auth.CreateUserExtension.API_LOGIN_USERS_NAMESPACE;
...
public class ApiAuthExtension implements BeforeEachCallback, AfterTestExecutionCallback {
    ...
    private void apiLogin(String username, String password) throws Exception {
        ...
        if (token == null) Assertions.fail("Invalid user credentials in @ApiLogin annotation");
